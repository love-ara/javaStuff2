...
public class MainApp {
    private static final Address dummyAddress = new Address("city", "country", "house number",
            "street", "state");
    private static final Admin admin = new Admin("id", "name", "email", "password", "phone");

    private static Customer customer = new Customer("id", "name", "email", "password", "phone");
    ...
    public static void startApp() {
        ...
        print("Welcome to E-store", "Welcome");
    ...
    private static void deleteAccount() {
        ...
        try {
            customer = admin.findCustomer(customerId);
        }
            ...
            validate(password);
            admin.removeCustomerAccount(customerId, password);
            isLoggedIn = false;
    ...
    private static void login() {
        ...
        print("Welcome to E-Store", "Login");
    ...
    private static void addToCart() {
        ...
        try {
            Product product = admin.findProductById(productId);
    ...
    private static void createAccount() {
        ...
        try {
            customer = admin.registerCustomer(id, name, email, password, phone);
            print("Account created successfully", "Success");
            print(STR."Your account id is \{customer.getId()}", "Success");
        }
        catch (RuntimeException e) {
            displayErrorMessage(e.getMessage());
            gotoMainMenu();
    ...
    private static void collectBillInformationDetails() {
        ...
        CreditCard cardInformation = getCreditCard();
    ...
    private static CreditCard getCreditCard() {
        ...
        return new CreditCard(creditCardCvv, creditCardExpirationDate, creditCardNumber, cardHolderName, cardType);
    }
    ...
    private static void updateCardInfo() {
        ...
        CreditCard updatedCardInfo = getCreditCard();
